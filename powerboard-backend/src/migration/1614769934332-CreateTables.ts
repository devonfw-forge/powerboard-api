...
export class CreateTables1614769934332 implements MigrationInterface {
    name = 'CreateTables1614769934332'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "client_status" ("id" SERIAL NOT NULL, "version" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "clientRating" integer NOT NULL, "sprintNumber" integer NOT NULL, "teamId" integer, "sprintId" integer, CONSTRAINT "REL_16a31ed3a3cc5249369bbd25c9" UNIQUE ("sprintId"), CONSTRAINT "PK_2fcaf8756581eab94bba1d006c5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "code_quality_snapshot" ("id" SERIAL NOT NULL, "version" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "bugs" integer NOT NULL, "debt" integer NOT NULL, "codeCoverage" integer NOT NULL, "status" character varying(255) NOT NULL, "snapshotTime" TIMESTAMP NOT NULL, "teamId" integer, CONSTRAINT "PK_f8d07080172f9eb6c516154ed48" PRIMARY KEY ("id"))`);
