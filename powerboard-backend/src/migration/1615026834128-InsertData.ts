...
export class InsertData1615026834128 implements MigrationInterface {
  name = 'InsertData1615026834128';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`INSERT INTO "team" ("id", "name", "business_unit_id" ) VALUES (2 ,'IKEA',14);`);
    ...
    await queryRunner.query(
      `INSERT INTO "sprint" ("id","sprint_number","status" , "start_date","end_date","team_id") VALUES (3, 11, 2,'2021-02-26', '2021-03-13',1);`,
    );
    await queryRunner.query(
      `INSERT INTO "sprint" ("id","sprint_number","status" , "start_date","end_date","team_id") VALUES (4, 21, 3,'2021-01-18', '2021-02-02',2);`,
    );
    await queryRunner.query(
      `INSERT INTO "sprint" ("id","sprint_number","status" , "start_date","end_date","team_id") VALUES (5, 22, 2,'2021-02-18', '2021-03-05',2);`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "sprint_snapshot" ("id","sprint_id","date_time") VALUES (1002, 3,'2021-03-03');`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "sprint_snapshot_metric" ("id","snapshot_id","metric_id","value" ) VALUES (4, 1002,2,30);`,
    );
