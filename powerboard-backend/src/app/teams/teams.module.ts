...
import { Burndown } from '../burndown/model/entities/burndown.entity';
import { BurndownCrudService } from '../burndown/services/burndown.crud.services';
import { SprintCrudService } from '../sprint/services/sprint.crud.service';
import { Sprint } from '../sprint/model/entities/sprint.entity';

@Module({
  imports: [TypeOrmModule.forFeature([Team, BusinessUnit, User, CodeQualitySnapshot,ClientStatus, TeamSpirit,Burndown, Sprint])],
  providers: [TeamCrudService, CodeQualitySnapshotCrudService, ClientStatusCrudService , TeamSpiritCrudService, BurndownCrudService,SprintCrudService],
