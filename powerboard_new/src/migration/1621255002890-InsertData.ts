...
export class InsertData1621255002890 implements MigrationInterface {
    name = 'InsertData1621255002890'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
          ...
          await queryRunner.query(
            `INSERT INTO "team" ("id","team_code", "logo", "name", "business_unit_id") VALUES ('46455bf7-ada7-495c-8019-8d7ab76d488e' ,'10012345','uploads\\logo\\team_logof1421c16-7ce3-44ad-a94b-5231bcea6887.jpg','Diamler Devops','46655bf7-ada7-495c-8019-8d7ab62d488e');`,
          );
          await queryRunner.query(
            `INSERT INTO "team" ("id","team_code","logo", "name", "business_unit_id") VALUES ('46455bf7-ada7-495c-8019-8d7ab76d489e' ,'10012346','' ,'Devon Offshore','46555bf7-ada7-495c-8019-8d7ab62d488e');`,
          );
          await queryRunner.query(
            `INSERT INTO "team" ("id", "team_code","logo","name", "business_unit_id" ) VALUES ('46455bf7-ada7-495c-8019-8d7ab76d490e' ,'10012347','', 'K&N','46655bf7-ada7-495c-8019-8d7ab62d488e');`,
          );
        ...
        //   );
          ...
          await queryRunner.query(
            `INSERT INTO "sprint" ("id","sprint_number","status" , "start_date","end_date","team_id","work_unit") VALUES ('20155bf8-ada5-495c-8019-8d7ab76d488e', 9, '11155bf3-ada5-495c-8019-8d7ab76d488e','2021-03-17', '2021-04-14','46455bf7-ada7-495c-8019-8d7ab76d488e' ,'11155bf2-ada5-495c-8019-8d7ab76d488e');`,
          );
          await queryRunner.query(
            `INSERT INTO "sprint" ("id","sprint_number","status" , "start_date","end_date","team_id","work_unit") VALUES ('20255bf8-ada5-495c-8019-8d7ab76d488e', 10, '11155bf3-ada5-495c-8019-8d7ab76d488e','2021-04-15', '2021-05-13','46455bf7-ada7-495c-8019-8d7ab76d488e' ,'11155bf2-ada5-495c-8019-8d7ab76d488e');`,
          );
          await queryRunner.query(
            `INSERT INTO "sprint" ("id","sprint_number","status" , "start_date","end_date","team_id", "work_unit") VALUES ('20355bf8-ada5-495c-8019-8d7ab76d488e', 11, '11155bf2-ada5-495c-8019-8d7ab76d488e','2021-05-14', '2021-06-11','46455bf7-ada7-495c-8019-8d7ab76d488e' ,'11155bf2-ada5-495c-8019-8d7ab76d488e' );`,
          );
          await queryRunner.query(
            `INSERT INTO "sprint" ("id","sprint_number","status" , "start_date","end_date","team_id", "work_unit") VALUES ('20455bf8-ada5-495c-8019-8d7ab76d488e', 21, '11155bf3-ada5-495c-8019-8d7ab76d488e','2021-04-15', '2021-05-13','46455bf7-ada7-495c-8019-8d7ab76d490e' ,'11155bf1-ada5-495c-8019-8d7ab76d488e');`,
          );
          await queryRunner.query(
            `INSERT INTO "sprint" ("id","sprint_number","status" , "start_date","end_date","team_id","work_unit") VALUES ('20555bf8-ada5-495c-8019-8d7ab76d488e', 22, '11155bf2-ada5-495c-8019-8d7ab76d488e','2021-05-14', '2021-06-11','46455bf7-ada7-495c-8019-8d7ab76d490e' ,'11155bf1-ada5-495c-8019-8d7ab76d488e');`,
          );
          ...
          await queryRunner.query(
            `INSERT INTO "sprint_snapshot" ("id","sprint_id","date_time") VALUES ('80155bf8-ada5-495c-8019-8d7ab76d488e', '20355bf8-ada5-495c-8019-8d7ab76d488e','2021-05-14 14:30:00');`,
          );
      
          await queryRunner.query(
            `INSERT INTO "sprint_snapshot" ("id","sprint_id","date_time") VALUES ('80255bf8-ada5-495c-8019-8d7ab76d488e', '20355bf8-ada5-495c-8019-8d7ab76d488e','2021-05-17 14:30:00');`,
          );
      
          await queryRunner.query(
            `INSERT INTO "sprint_snapshot" ("id","sprint_id","date_time") VALUES ('80355bf8-ada5-495c-8019-8d7ab76d488e', '20555bf8-ada5-495c-8019-8d7ab76d488e','2021-05-17 14:30:00');`,
          );
          await queryRunner.query(
            `INSERT INTO "sprint_snapshot" ("id","sprint_id","date_time") VALUES ('80455bf8-ada5-495c-8019-8d7ab76d488e', '20255bf8-ada5-495c-8019-8d7ab76d488e','2021-04-30 14:30:00');`,
          );
          await queryRunner.query(
            `INSERT INTO "sprint_snapshot" ("id","sprint_id","date_time") VALUES ('80555bf8-ada5-495c-8019-8d7ab76d488e', '20155bf8-ada5-495c-8019-8d7ab76d488e','2021-04-10 14:30:00');`,
          );
          await queryRunner.query(
            `INSERT INTO "sprint_snapshot" ("id","sprint_id","date_time") VALUES ('80655bf8-ada5-495c-8019-8d7ab76d488e', '20455bf8-ada5-495c-8019-8d7ab76d488e','2021-05-10 14:30:00');`,
          );
          ...
          await queryRunner.query(
            `INSERT INTO "user_info"("id", "first_name", "last_name" ,"center" ,"team_spirit_name") Values('55cf1dfd-43e9-5dd4-8257-a6ba5c70e33d', 'Raj' ,'Singh' ,'ADCenter Bangalore', '');`,
          );
          await queryRunner.query(
            `INSERT INTO "user_info"("id", "first_name", "last_name" ,"center" ,"team_spirit_name") Values('56cf1dfd-43e9-5dd4-8257-a6ba5c70e33d', 'Azhar' ,'Hussain' ,'ADCenter Bangalore', '');`,
          );
          await queryRunner.query(
            `INSERT INTO "user"("id", "username", "password","email" ,"role", "user_info_id") Values('10cf1dfd-43e9-4cc4-8257-a6ba5c70e33d', 'raj11' ,'$2b$12$.hA7MmRGIzsr7v.eYFRtuOUTNw5WEqkGPcE92EX6opaiVMbr77fme','raj@capgemini.com', 0, '55cf1dfd-43e9-5dd4-8257-a6ba5c70e33d');`,
          );
      
          await queryRunner.query(
            `INSERT INTO "user"("id", "username", "password", "email", "role", "user_info_id") Values('11cf1dfd-43e9-4cc4-8257-a6ba5c70e34d', 'siva11' ,'$2b$12$.hA7MmRGIzsr7v.eYFRtuOUTNw5WEqkGPcE92EX6opaiVMbr77fme','siva@capgemini.com' ,0, '56cf1dfd-43e9-5dd4-8257-a6ba5c70e33d');`,
          );
