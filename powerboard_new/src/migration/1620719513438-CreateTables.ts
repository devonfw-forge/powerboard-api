...
export class CreateTables1620719513438 implements MigrationInterface {
    name = 'CreateTables1620719513438'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "version" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "username" character varying(255) NOT NULL, "password" character varying(255) NOT NULL, "role" integer NOT NULL DEFAULT '0', "user_info_id" uuid, CONSTRAINT "REL_ee24a311e8099f9f44424df108" UNIQUE ("user_info_id"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
